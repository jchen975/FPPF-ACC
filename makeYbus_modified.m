function [Ybus, Yft, Ytf, A] = makeYbus_modified(baseMVA, bus, branch)
%%
% Modified version returns the incidence matrix A (with potential parallel 
% branches between buses) and the off-diagonal entries of Y as arrays (in the 
% order of the branches listed in the test case file).

% Modified in 2021 from the code written by John W. Simpson-Porco and MATPOWER. 
